...
##Load all data - currently file paths are all messed up - need to change them back to absolute paths for this to work locally
import os
import os
cur_path = os.path.dirname(__file__)
data = pd.read_csv(os.path.join(cur_path, '..', 'data','02_intermediate','energy_harvesters_vector'), header=2, index_col=0) #Load just numerical information
#data = pd.read_csv('../data/02_intermediate/energy_harvesters_functionsandflows.csv',index_col=0, header=0) #data from Weaver method
#data = pd.read_csv('../data/02_intermediate/appliances_and_toys_vector_V2.csv',index_col=0, header=1)
#data = pd.read_csv('../data/02_intermediate/combined_vector.csv',index_col=0, header=1)
#data = pd.read_csv('../data/02_intermediate\limitedcombined_adjacencymatrix.csv',index_col=0, header=1)
...
#hamming_sim_full.to_csv('../data/03_processed/appliances_and_toys_hammingdist_V2.csv')
#jaccard_sim_full.to_csv('../data/03_processed/appliances_and_toys_jaccarddist_V2.csv')
#cosine_sim_full.to_csv('../data/03_processed/appliances_and_toys_cosinedist_V2.csv')

#networkdata = pd.read_csv('../data/03_processed/energy_harvesters_lambdadistance.csv',index_col=0, header=0)
networkdata = pd.read_csv('../data/03_processed/energy_harvesters_lambdadistance_sorted.csv',index_col=0, header=0)
#networkdata = pd.read_csv('../data/03_processed/appliances_and_toys_lambdadistance_V2.csv',index_col=0, header=0)
#networkdata = pd.read_csv('../data/03_processed/combined_lambdadistance.csv',index_col=0, header=0)
#networkdata = pd.read_csv('../data/03_processed/limitedcombined_lambdadistance.csv',index_col=0, header=0)


#networkdata_ged = pd.read_csv('../data/03_processed/energy_harvesters_geddistance.csv',index_col=0, header=0)
networkdata_ged = pd.read_csv('../data/03_processed/energy_harvesters_geddistance_sorted.csv',index_col=0, header=0)
#networkdata_ged = pd.read_csv('../data/03_processed/appliances_and_toys_geddistance_V2.csv',index_col=0, header=0)
#networkdata_ged = pd.read_csv('../data/03_processed/combined_geddistance.csv',index_col=0, header=0)
#networkdata_ged = pd.read_csv('../data/03_processed/limitedcombined_geddistance.csv',index_col=0, header=0)


#networkdata_deltacon = pd.read_csv('../data/03_processed/energy_harvesters_deltacon.csv',index_col=0, header=0)
networkdata_deltacon = pd.read_csv('../data/03_processed/energy_harvesters_deltacon_sorted.csv',index_col=0, header=0)
#networkdata_deltacon = pd.read_csv('../data/03_processed/appliances_and_toys_deltacon_V2.csv',index_col=0, header=0)
#networkdata_deltacon = pd.read_csv('../data/03_processed/combined_deltacon.csv',index_col=0, header=0)
#networkdata_deltacon = pd.read_csv('../data/03_processed/limitedcombined_deltacon.csv',index_col=0, header=0)

networkdata_veo = pd.read_csv('../data/03_processed/energy_harvesters_vertexedgeoverlap.csv',index_col=0, header=0)
networkdata_resistance = pd.read_csv('../data/03_processed/energy_harvesters_resistance.csv',index_col=0, header=0)
networkdata_netsimile = pd.read_csv('../data/03_processed/energy_harvesters_netsimile.csv',index_col=0, header=0)
...
#plt.ylim([0,25])
plt.show()
#testfig.savefig('DistributionsV2.pdf', dpi=300)
...
plt.show()
#f.savefig('RankCorrV3.pdf', dpi=300)
